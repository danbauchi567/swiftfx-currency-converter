...
const API_ENDPOINT = 'https://api.allorigins.win/raw?url=https://api.exchangerate.host/convert';
const SYMBOLS_ENDPOINT = 'https://api.allorigins.win/raw?url=https://api.exchangerate.host/symbols';
